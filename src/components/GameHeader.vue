<!-- <template>
  <header class="game-header">
    ...
    <div class="hud-container" v-if="authStore.token">
      ...
      <router-link to="/notifications" class="noti-node" :class="{ 'has-signal': notiStore.unreadCount > 0 }">
...
const xpPercent = computed(() => {
  ...
  // Giả định công thức EXP từ store
...
/* ĐÃ CHỈNH: Linh Thạch (Jade) thành màu Vàng Cổ */
.jade .res-icon {
  color: #C5A059; 
}
...
/* ĐÃ CHỈNH: Chân Khí (Energy) thành màu Đỏ Ấn Triện */
.energy .res-icon {
  color: #8A1C1C;
}
