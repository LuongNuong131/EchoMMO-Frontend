    ...
    <div class="battle-container" v-if="battleStore.enemy">
      ...
      <div class="controls">
        <div v-if="battleStore.status === 'ONGOING'">
          ...
          <button class="btn-action skill" @click="activateBuff"
...
const lastLog = computed(() => {
  ...
  return battleStore.combatLogs[battleStore.combatLogs.length - 1].replace(/<[^>]*>/g, '');
});

// [LOGIC ẢNH QUÁI] Lấy từ battleStore.enemyVisual nếu có (để khớp với Explore), nếu không thì fallback
    ...
    <div class="battle-layout">
      ...
      <main class="center-panel">
        ...
        <div v-else class="loading-arena">
          <i class="fas fa-circle-notch fa-spin"></i> Đang tìm đối thủ...
        </div>

        <div class="chat-section">
          <div class="chat-header">KÊNH THẾ GIỚI</div>
          <div class="chat-messages custom-scroll" ref="chatBox">
            <div class="chat-msg system">
              <span class="sender">[Hệ thống]:</span> Chào mừng đến với EchoMMO!
            </div>
            <div class="chat-msg user">
              <span class="sender">Hắc Kiếm:</span> Có ai đi phó bản không?
            </div>
            <div class="chat-msg user">
              <span class="sender">Tiểu Long Nữ:</span> Cần mua gỗ sll.
            </div>
          </div>
      ...
      <aside class="side-panel right-panel">
        ...
        <div class="char-detail-card">
          ...
          <div class="detail-row">
            ...
            <span class="val">{{ charStore.character?.baseSpeed || 10 }}</span>
          </div>
          <div class="detail-row">
...
const enemyHpPercent = computed(() => {
  if (!battleStore.enemyMaxHp) return 0;
  return Math.max(0, (battleStore.enemyHp / battleStore.enemyMaxHp) * 100);
});

const playerHpPercent = computed(() => {
  if (!battleStore.playerMaxHp) return 0;
